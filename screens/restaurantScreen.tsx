    ...
    <View>
      ...
      <ScrollView>
        <View className='relative'>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Home')} className='absolute top-14 left-4 bg-gray-50 p-2 rounded-full shadow'>
            <Icon.ArrowLeft
              strokeWidth={3} stroke={themeColors.bgColor(1)}
            />
          </TouchableOpacity>
        ...
        <View style={{ borderTopLeftRadius: 40, borderTopRightRadius: 40 }} className='bg-white mt-12 pt-6'>
          ...
          <View className='flex-row space-x-2 my-1'>
            <View className='flex-row items-center space-x-1'>
              <Image className='h-4 w-4' source={require('../assets/images/restaurants/pngwing.com.png')}></Image>
